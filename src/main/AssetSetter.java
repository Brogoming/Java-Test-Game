...
import entity.enemies.MON_GreenSlime;
...
public class AssetSetter {
	...
	public void setEnemies() {
		...
		gamePanel.enemies[0].worldX = gamePanel.tileSize * 23;
		gamePanel.enemies[0].worldY = gamePanel.tileSize * 36;

		gamePanel.enemies[1] = new MON_GreenSlime(gamePanel);
		gamePanel.enemies[1].worldX = gamePanel.tileSize * 23;
		gamePanel.enemies[1].worldY = gamePanel.tileSize * 37;
	}
}